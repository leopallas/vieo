...
<body>
<form action="<%=request.getContextPath()%>/page/r_report.jsp" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">统计报表</span></td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <div style="margin:20px;text-align: center;">
          <div style="width:340px;margin-left:100px;margin-top:30px;height:190px;">
              ...
              <div style="height:25px;line-height:25px;clear:both;">
                  <div style="float:left;width:70px;text-align: left;">时间类型：</div>
                  <div style="float:left;margin-left:5px;">
                    <select name="type">
