...
%>
<%
    java.util.List<PictureVO> adminVOList = new DBConnection().listPicture(clhP, fromP, toP, xc, tw, bw, gzfj, gzfl,5000,1);
...
<%
    ...
    document.open();
    document.add(new Paragraph(CT.toString()));
    }
