...
public class IdGeneratorHelper {
    ...
    private MessageDigest getDigest() {
        if (digest == null) {
            ...
            // System.out.println("Using MessageDigest: " +
            // digest.getAlgorithm());
        }
    ...
    private static final IdGeneratorHelper idGenerator       = new IdGeneratorHelper();
    ...
    public static void main(String[] args) {
        // for (int i = 0; i < 100; i++) {
        // System.out.println(IdGeneratorHelper.getInstance().generateId());
        // }

        for (int i = 0; i < 100; i++) {
            System.out.println(IdGeneratorHelper.getID());
        }
    }
